...
routes.post("/register", forceSSL/*, passport.authenticate("register")*/, function(req, res){
...
routes.post("/login", forceSSL/*, passport.authenticate("login")*/, function(req, res){
  res.status(200).json("{ body: login }")
})
...
routes.get("/protected", forceSSL/*, passport.authenticate("login")*/, function(req, res){
